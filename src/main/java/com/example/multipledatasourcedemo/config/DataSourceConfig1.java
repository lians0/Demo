 ...
 */
@Configuration
//@MapperScan(basePackages = {"com.example.multipledatasourcedemo.mapper.db1","com.example.multipledatasourcedemo.mapper.db1"}, sqlSessionFactoryRef = "db1SqlSessionFactory")
...
//    @Primary // 表示这个数据源是默认数据源, 这个注解必须要加，因为不加的话spring将分不清楚那个为主数据源（默认数据源）
    ...
    public JdbcTemplate sqlSessionFactory(@Qualifier("db1DataSource") DataSource dataSource){
